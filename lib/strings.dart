...
const EXCESSSO_TENTATIVAS = "Excesso de tentativas, tente mais tarde";
const LOGIN = "Login";
const LOGAR = "Logar";
const FAZER_LOGIN = "Fazer Login";
const OU = "OU";
const LOGAR_COM_GOOGLE = "Logar com Google";
const USE_GOOGLE_ACCOUNT = "Usar conta do Google";
const SALVAR = "Salvar";
const ENVIAR = "Enviar";
const FORGOT_PASSWORD_TEXT = "Será enviado um e-mail para recuperar a sua senha, verifique sua caixa de entrada e spam.";
const OBSERVACAO_ENVIAR_EMAIL = "Você receberá um e-mail com um link de confirmação!\n\nClick no link para ativar sua conta.\nVerifique a caixa de entrada e spam.";
